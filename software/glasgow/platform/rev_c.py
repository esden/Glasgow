...
class _GlasgowPlatformRevC(GlasgowPlatformICE40):
    ...
    connectors  = [
        ...
        #                     GDD 3V3 11N GND 11P GND GND 12P 10P 12N 10N GND GND 9N  8P  9P  8N  GND GND 7N  6P  7P
        #                     6N  GND GND 5N  3P  5P  3N  GND GND 4P  2N  4N  2P  GND GND 1N  0P  1P  0N  GND GND VIO
    ]
